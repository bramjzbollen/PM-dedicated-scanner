  ...
  return (
    <main className="flex-1 container py-8">
      <div className="space-y-8">
        ...
        <div className="h-72 rounded-2xl glass-card-premium bg-white/[0.04] border border-white/[0.08] shimmer animate-stagger-in" style={{ animationDelay: '400ms', animationFillMode: 'backwards' }} />
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="h-64 rounded-2xl glass-card-premium bg-white/[0.04] border border-white/[0.08] shimmer animate-stagger-in" style={{ animationDelay: '560ms', animationFillMode: 'backwards' }} />
        </div>
      </div>
    </main>
  );
